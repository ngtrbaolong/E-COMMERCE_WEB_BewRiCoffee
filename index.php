...
<body>
    ...
    <section class="header">
        ...
        <a href="index.php" class="logo"> <img src="images/BewRi Coffee.png" alt="Logo" style="width: 100px;"></a>
        <nav class="navbar">
    ...
    <section class="home" id="home">
        ...
        <div class="swiper home-slider">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide slide" style="background: url(images/background.jpg);">
                    <div class="content">
                        <h3>BewRi Coffee</h3>
